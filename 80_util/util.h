...
// ..................................................................
// ..................................................................
template<class Real> // Real debería ser double o float
#ifdef __CUDACC__   /* también está __CUDA_ARCH__ */
__device__ __host__
#endif
void intensidadAConcentracion( Real * samples, const unsigned int size)
{

	Real muestra = samples[0];
	Real referencia = (muestra*muestra*muestra * 2e-8) - (muestra*muestra * 2e-5) + (muestra * 0.0143) - 0.4091;
  

  for (unsigned int i=0; i<size; i++) {
	muestra = samples[i];
	Real v = (muestra*muestra*muestra * 2e-8) - (muestra*muestra * 2e-5) + (muestra * 0.0143) - 0.4091;

	v = (v - referencia) / 4.39;

	  // printf ("antes=%f, despues=%f ", muestra, v);
